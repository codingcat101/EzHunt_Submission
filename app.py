...
def read_jd_from_csv(uploaded_file): 
    try:
        ...
        jd_columns = ['job_description', 'jobdescription', 'description', 'jd', 'job', 'Job Description']
...
<div style="text-align: center; margin-top: 3rem; padding-top: 1rem; border-top: 1px solid #eee; color: #777;">
    EzHunt AI Recruitment Assistant | Aarchi Kothari | © 2025
</div>
""", unsafe_allow_html=True)